...
function distinct(str) {
  if (str.match(/a/gi) != null && str.match(/(e|i|o|u)/gi) != null)
    return false;
  if (str.match(/e/gi) != null && str.match(/(a|i|o|u)/gi) != null)
    return false;
  if (str.match(/i/gi) != null && str.match(/(e|a|o|u)/gi) != null)
    return false;
  if (str.match(/o/gi) != null && str.match(/(e|i|a|u)/gi) != null)
    return false;
  if (str.match(/u/gi) != null && str.match(/(e|i|o|a)/gi) != null)
    return false;
  return true;
}
...
// function filterDistinctVowel(str) {}
